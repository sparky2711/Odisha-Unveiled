			...
			this.props.defaultSuggestions || this.props.autosuggest ? (0, _core.jsx)(_downshift2.default, _extends({
				...
				render: function render(_ref) {
					...
					return (0, _core.jsx)(
						...
						!_this3.hasCustomRenderer && isOpen && finalSuggestionsList.length ? (0, _core.jsx)(
							'ul',
							{
							...
							finalSuggestionsList.slice(0, size).map(function (item, index) {
								return (0, _core.jsx)(
									...
									_extends({}, getItemProps({ item: item }), {
										...
										style: {
											backgroundColor: _this3.getBackgroundColor(highlightedIndex, _this3.topSuggestions.length + index)
										}
									}),
									(0, _core.jsx)(
										Text,
	...
	_createClass(CategorySearch, [{
		...
		get: function get() {
			var _props4 = this.props,
			    ...
			    popularSuggestions = _props4.popularSuggestions,
			    showDistinctSuggestions = _props4.showDistinctSuggestions;
			var currentValue = this.state.currentValue;

			return enableQuerySuggestions || enablePopularSuggestions ? (0, _helper.getTopSuggestions)(popularSuggestions, currentValue, showDistinctSuggestions) : [];
		}
	}]);
...
var _initialiseProps = function _initialiseProps() {
	...
	this.getCombinedAggsQuery = function () {
		var _props5 = _this4.props,
		    categoryField = _props5.categoryField,
		    aggregationField = _props5.aggregationField;
	...
	this.renderIcons = function () {
		...
		var _props9 = _this4.props,
		    showIcon = _props9.showIcon,
		    showClear = _props9.showClear,
		    renderMic = _props9.renderMic,
		    getMicInstance = _props9.getMicInstance,
		    showVoiceSearch = _props9.showVoiceSearch,
		    iconPosition = _props9.iconPosition,
	...
	this.renderNoSuggestion = function () {
		...
		var _props10 = _this4.props,
		    ...
		    renderNoSuggestion = _props10.renderNoSuggestion,
	...
	this.renderLoader = function () {
		var _props11 = _this4.props,
		    loader = _props11.loader,
		    isLoading = _props11.isLoading,
		    themePreset = _props11.themePreset,
	...
	this.getComponent = function () {
		...
		var _props13 = _this4.props,
		    ...
		    aggregationData = _props13.aggregationData,
		    promotedResults = _props13.promotedResults,
		    customData = _props13.customData,
		    rawData = _props13.rawData;
		var currentValue = _this4.state.currentValue;
		...
		var data = {
			...
			popularSuggestions: _this4.topSuggestions
		};
